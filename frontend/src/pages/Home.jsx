...
const FAQS = [
    ...
    { q: 'How does the equity ledger work?', a: 'Every project has a live equity ledger tracking ownership percentages for owners, developers, investors and optional realtor carried equity. Realtor equity percentages are defined per project and can vary by deal. Vesting conditions, distribution records and payment logs are stored with traceable transaction IDs.' },
